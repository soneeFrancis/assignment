...
def findbus(request):
    ...
    if request.method == 'POST':
        ...
        if bus_list:
            ...
            return render(request, 'Booking/findbus.html', context)
    else:
        return render(request, 'Booking/findbus.html')
    ...
    if request.method == 'POST':
        ...
        if bus:
            if bus.rem > int(seats_r):
                ...
                # book.save()
                return render(request, 'Booking/bookings.html', locals())
            else:
...
def seebookings(request,new={}):
    ...
    if book_list:
        return render(request, 'Booking/booklist.html', locals())
    else:
...
def signup(request):
    ...
    if request.method == 'POST':
        ...
        if user:
            login(request, user)
            return render(request, 'Booking/thank.html')
        else:
...
def signin(request):
    ...
    if request.method == 'POST':
        ...
        if user:
            ...
            context["error"] = "Provide valid credentials"
            return render(request, 'Booking/signin.html', context)
    else:
